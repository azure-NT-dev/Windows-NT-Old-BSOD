...
$stopCodes = @(
    @{ Code = "IRQL_NOT_LESS_OR_EQUAL"; Hex = "0x0000000A"; Failed = "ndis.sys"; Type = "Standard" },
    @{ Code = "APC_INDEX_MISMATCH"; Hex = "0x00000001"; Failed = "ntoskrnl.exe"; Type = "Standard" },
    @{ Code = "KMODE_EXCEPTION_NOT_HANDLED"; Hex = "0x0000001E"; Failed = "ntoskrnl.exe"; Type = "Standard" },
    @{ Code = "PAGE_FAULT_IN_NONPAGED_AREA"; Hex = "0x00000050"; Failed = "ntoskrnl.exe"; Type = "Standard" },
    @{ Code = "BAD_POOL_CALLER"; Hex = "0x000000C2"; Failed = "ndis.sys"; Type = "Standard" },
    ...
    @{ Code = "DATA_BUS_ERROR"; Hex = "0x0000002E"; Failed = ""; Type = "Standard" },
    @{ Code = "NO_MORE_SYSTEM_PTES"; Hex = "0x0000003F"; Failed = "ntoskrnl.exe"; Type = "Standard" },
    @{ Code = "MISMATCHED_HAL"; Hex = "0x00000079"; Failed = "hal.dll"; Type = "Standard" },
    @{ Code = "KERNEL_STACK_INPAGE_ERROR"; Hex = "0x00000077"; Failed = "ntoskrnl.exe"; Type = "Standard" },
    @{ Code = "REGISTRY_ERROR"; Hex = "0x00000051"; Failed = "ntoskrnl.exe"; Type = "Standard" },
    @{ Code = "BAD_SYSTEM_CONFIG_INFO"; Hex = "0x00000074"; Failed = "ntoskrnl.exe"; Type = "Standard" },

    @{ Code = "DRIVER_POWER_STATE_FAILURE"; Hex = "0x0000009F"; Failed = "USBPORT.SYS"; Type = "Standard" },
    @{ Code = "DRIVER_VERIFIER_DETECTED_VIOLATION"; Hex = "0x000000C4"; Failed = "verifier.sys"; Type = "Standard" },
    @{ Code = "DRIVER_CORRUPTED_EXPOOL"; Hex = "0x000000C5"; Failed = "ntoskrnl.exe"; Type = "Standard" },
    @{ Code = "DRIVER_UNLOADED_WITHOUT_CANCELLING_PENDING_OPERATIONS"; Hex = "0x000000CE"; Failed = "ntoskrnl.exe"; Type = "Standard" },
    ...
    @{ Code = "WHEA_UNCORRECTABLE_ERROR"; Hex = "0x00000124"; Failed = ""; Type = "BootFailure" },
    @{ Code = "CLOCK_WATCHDOG_TIMEOUT"; Hex = "0x00000101"; Failed = "intelppm.sys"; Type = "Standard" },

    @{ Code = "ATTEMPTED_WRITE_TO_READONLY_MEMORY"; Hex = "0x000000BE"; Failed = "ntoskrnl.exe"; Type = "Standard" },
    @{ Code = "CRITICAL_OBJECT_TERMINATION"; Hex = "0x000000F4"; Failed = "csrss.exe"; Type = "UserModeTermination" },
    @{ Code = "FAT_FILE_SYSTEM"; Hex = "0x00000023"; Failed = "fastfat.sys"; Type = "Standard" },
    @{ Code = "BUGCODE_USB_DRIVER"; Hex = "0x000000FE"; Failed = "USBPORT.SYS"; Type = "Standard" },

    @{ Code = "VIDEO_TDR_FAILURE"; Hex = "0x00000116"; Failed = "nvlddmkm.sys"; Type = "Standard" }
)
...
if ($errorType -ne "BootFailure" -and $failingFile) {
...
$form.Add_Shown({
    ...
    for ($pct = 0; $pct -le 100; $pct += (Get-Random -Min 2 -Max 7)) {
